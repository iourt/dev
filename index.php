...
<div class="home_wrapper clearfix">
    <div class="home_left clearfix">
        ...
        <div class="h_border" style="height:526px;">
            ...
            <div style="padding:0 20px;">
                <table class="home_list_table col_mod_01" cellspacing="0" cellpadding="0">
                    <tr>
                        <th class="w_col w_1">网贷平台</th>
                        <th class="w_col w_2">项目名称</th>
                        <th class="w_col w_3">年化利率</th>
                        <th class="w_col w_4">期限</th>
                        <th class="w_col w_5">收益金额(元)</th>
                        <th class="w_col w_6"></th>
                    </tr>
                    <tr>
                        <td class="w_col w_1"><a href="">陆金所</a></td>
                        <td class="w_col w_2">
                            稳盈-安e贷二期
                            <em class="box_detail">
                        ...
                        <td class="w_col w_3">8.61%</td>
                        <td class="w_col w_4">36个月</td>
                        <td class="w_col w_5">
                            <div class="list_detail">13278</div>
                            <div class="list_detail_float">
                        ...
                        <td class="w_col w_6 a_box_yellow"><a href="">去投资</a></td>
                    </tr>
                    <tr>
                        <td class="w_col w_1"><a href="">人人贷</a></td>
                        <td class="w_col w_2">借款进货</td>
                        <td class="w_col w_3">12.50%</td>
                        <td class="w_col w_4">6个月</td>
                        <td class="w_col w_5">
                            <div class="list_detail">9100</div>
                            <div class="list_detail_float">
                                <div class="list_detail_icon"></div>
                                <div class="list_detail_close"></div>
                                <div class="scroll clearfix">
                    ...
                    <tr>
                        <td class="w_col w_1"><a href="">万汇投融</a></td>
                        <td class="w_col w_2">240次无逾期，谢谢大家</td>
                        <td class="w_col w_3">18.87%</td>
                        <td class="w_col w_4">6个月</td>
                        <td class="w_col w_5">
                            <div class="list_detail">2250</div>
                            <div class="list_detail_float">
                                <div class="list_detail_icon"></div>
                                <div class="list_detail_close"></div>
                                <div class="scroll clearfix">
                    ...
                    <tr>
                        <td class="w_col w_1"><a href="">爱投资</a></td>
                        <td class="w_col w_2">月息通 YAE14A512</td>
                        <td class="w_col w_3">13.57%</td>
                        <td class="w_col w_4">6个月</td>
                        <td class="w_col w_5">
                            <div class="list_detail">9000</div>
                            <div class="list_detail_float">
                                <div class="list_detail_icon"></div>
                                <div class="list_detail_close"></div>
                                <div class="scroll clearfix">
                    ...
                    <tr>
                        <td class="w_col w_1"><a href="">陆金所</a></td>
                        <td class="w_col w_2">稳盈-安e贷二期</td>
                        <td class="w_col w_3">12.00%</td>
                        <td class="w_col w_4">12个月</td>
                        <td class="w_col w_5">
                            <div class="list_detail">9000</div>
                            <div class="list_detail_float">
                                <div class="list_detail_icon"></div>
                    ...
                    <tr>
                        <td class="w_col w_1"><a href="">拍拍贷</a></td>
                        <td class="w_col w_2">
                            借款进货
                            <em class="box_detail">
                    ...
                    <tr>
                        ...
                        <td class="w_col w_2">
                            月息通 YAE14A512
                            <em class="box_detail">
                                <span class="span_box_yellow">奖</span>
                                <div class="box_detail_show">
                                    <div class="box_detail_icon"></div>
                                    <div class="box_detail_text">
                                        奖励0.1%
                        ...
                        <td class="w_col w_3">12.25%</td>
                        <td class="w_col w_4">12个月</td>
                        <td class="w_col w_5">
                            <div class="list_detail">2500</div>
                            <div class="list_detail_float">
                                <div class="list_detail_icon"></div>
                                <div class="list_detail_close"></div>
                                <div class="scroll clearfix">
        ...
        <div class="h_border" style="height:511px;">
            ...
            <div style="padding:0 20px;">
                <table class="home_list_table col_mod_02" cellspacing="0" cellpadding="0">
                    <tr>
                        <th class="w_col w_1">基金名称</th>
                        <th class="w_col w_2">基金公司</th>
                        <th class="w_col w_3">万份收益（元）</th>
                        <th class="w_col w_4">单日年化收益</th>
                        <th class="w_col w_5">七日年化收益</th>
                        <th class="w_col w_6">&nbsp;</th>
                    </tr>
                    <tr>
                        ...
                        <td class="w_col w_3">
                            <span class="span_font_red">1.7840</span>
                            <span class="span_font_gray">01-28</span>
                        </td>
    ...
    <div class="home_right clearfix">
        ...
        <div class="h_border">
            ...
            <ul class="list_point clearfix">
                <li><a href="">理财产品常见名词的解释</a></li>
                <li><a href="">理财产品的四种收益率</a></li>
                <li><a href="">你所不知道的银行理财</a></li>
                <li><a href="">月光职场女性学会理财 小九九变...</a></li>
                <li><a href="">小小积蓄理出惊人财富 对话理财...</a></li>
                <li><a href="">看85后小两口的六大理财秘笈：...</a></li>
                <li><a href="">理财产品的四种收益率</a></li>
                <li><a href="">理财产品的四种收益率</a></li>
                <li><a href="">你所不知道的银行理财</a></li>
                <li><a href="">月光职场女性学会理财 小九九变...</a></li>
...
<div class="home_border_988 clearfix">
    ...
    <div class="home_list_slide clearfix">
        ...
        <!-- 这里的调用个数保持 3的倍数 加 1 个 -->
    </div>
</div>

<div class="home_border_988 clearfix">
    <h3 class="title_01 title_green">
        <dl>
            <dt class="title_l"><strong>银行理财</strong><span>|</span>投资门槛较高</dt>
            <dd class="title_r"><span>当前投资金额50000元</span></dd>
        </dl>
    </h3>
    <ul class="money_list clearfix">
        <li>
            ...
            <dl class="money_num clearfix">
                <dd>
                    <div class="money_num_col">
                        <span>5.90%</span><br>
                        预期年化收益
                    </div>
                    <div class="money_num_col hidden_text">
                        <span>5.10%</span><br>
                        实际年化收益
                        <samp>
            ...
            <div class="money_time clearfix" data-time="2014-03-18 18:52:00">
        ...
        <li>
            ...
            <div class="money_time clearfix" data-time="2014-03-17 18:52:00">
                <div class="clock_text">抢购倒计时</div>
                <div class="clock_time">
                    <span>00</span>天<span>00</span>时<span>00</span>分<span>00</span>秒
                </div>
        ...
        <li>
            ...
            <div class="money_time clearfix" data-time="2014-03-15 21:46:00">
                <div class="clock_text">抢购已开始</div>
                <div class="clock_time">
                    <span>00</span>天<span>00</span>时<span>00</span>分<span>00</span>秒
                </div>
            </div>
