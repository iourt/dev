...
<div class="wrap clearfix">
	<div class="border_03" style="margin-bottom:30px;">
		...
		<tr>
			<th class="null"></th>
			<th class="hit_box col_01 up">产品名</th>
			<th class="hit_box col_02 down">互联网渠道</th>
			<th class="hit_box col_03 up">基金名称</th>
			<th class="hit_box col_04 up">
				万元收益<br>
				<span class="color_gray">(元/日)</span>
			</th>
			<th class="col_th" colspan="6">
				<div>年化收益率</div>
				<ul>
					<li class="hit_box col_05 down">单日</li>
