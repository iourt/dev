...
<div class="wrap clearfix">
	<div class="border_04" style="margin-bottom:20px;">
		...
		<tr>
			<th class="null"></th>
			<th class="hit_box col_01 up">基金名称</th>
			<th class="hit_box col_02 down">基金代码</th>
			<th class="hit_box col_03 up">基金公司</th>
			<th class="hit_box col_04 up">
				万元收益<br>
			...
			<th class="col_05" colspan="6">
				<div>年化收益率</div>
				<ul>
					<li class="hit_box col_05 up">单日</li>
					<li class="hit_box col_06 up">7日</li>
					<li class="hit_box col_07 up">14日</li>
					<li class="hit_box col_08 up">35日</li>
					<li class="hit_box col_09 up">2个月</li>
					<li class="col_box">
